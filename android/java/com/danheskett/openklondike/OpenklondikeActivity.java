package com.danheskett.openklondike;
 ...
 */
public class OpenklondikeActivity extends NativeActivity {

    // NativeActivity loads libopenklondike.so by dlopen()ing it in framework
    ...
    static {
        System.loadLibrary("openklondike");
    }
